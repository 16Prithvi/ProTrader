            ...
            <div className="flex items-center gap-4 w-full md:w-auto overflow-x-auto pb-1 md:pb-0">
                ...
                <div className="relative hidden lg:block">
                    <input
                        ...
                        className="bg-surfaceHighlight/30 border border-white/5 rounded-xl px-4 py-2 text-sm text-textMain focus:outline-none focus:ring-2 focus:ring-primary/50 w-40"
                    />
                    <Search className="w-3.5 h-3.5 text-textMuted absolute right-3 top-1/2 -translate-y-1/2" />
                </div>
            </div>
        </div>
    );
